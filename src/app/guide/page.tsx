  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        route: '/social',
        icon: ImageIcon,
        description: 'Posts réseaux sociaux générés par IA',
        roi: '+50% engagement (likes, comments, shares)',
        elements: [
          {
            name: 'Engagement rate',
            what: '(Likes + Comments + Shares) / Followers × 100',
            how: 'Benchmark: 2-5% selon plateforme. Instagram > Facebook > LinkedIn.',
            why: 'Mesure la qualité de votre contenu social',
            source: 'API Meta Business Suite',
            status: 'warning',
            action: 'Fournir accès Meta Business Suite',
          },
        ],
      },
      {
