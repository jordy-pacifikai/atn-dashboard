...
const guideSteps: GuideStep[] = [
  ...
  },
  {
    ...
    name: 'Social Monitor',
    category: 'Marketing Automatisé',
    purpose: 'Surveillance en temps réel des mentions d\'Air Tahiti Nui sur les réseaux sociaux. L\'IA analyse le sentiment, priorise les messages et génère des réponses adaptées.',
    interpretation: [
      '**Sentiment score** : Score de 0-100 mesurant si la mention est positive, neutre ou négative.',
      '**Reach** : Nombre de personnes potentiellement exposées à cette mention.',
      '**Priorité** : Messages négatifs ou à fort reach = priorité haute pour répondre rapidement.',
    ],
    roiMetrics: {
      value: '+50% réactivité',
      description: 'Réponse aux mentions en moins de 2h au lieu de 24h+ grâce à l\'alerte instantanée et aux suggestions de réponses IA.',
      calculation: 'Temps moyen réponse sans IA - Temps moyen avec IA = économie 50%+',
    },
    keyFeatures: [
      'Détection mentions multi-plateforme',
      'Analyse sentiment par IA',
      'Suggestions de réponses générées',
      'Alertes prioritaires temps réel',
    ],
    useCases: [
      'Répondre aux clients mécontents rapidement',
      'Remercier les ambassadeurs',
      'Détecter les crises potentielles',
      'Mesurer la réputation en ligne',
    ],
    dataSource: 'API Meta, Twitter, LinkedIn',
    updateFrequency: 'Scan toutes les heures',
    dependencies: [
      'Accès API réseaux sociaux',
      'Mots-clés de surveillance définis',
      'Guidelines de réponse validées',
      'Workflow d\'escalade si crise',
    ],
  },
  {
