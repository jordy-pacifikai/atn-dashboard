...
const pagesWithGuides = [
  ...
  },
  {
    path: '/lead-scoring',
    guides: [
      'leadscoring-btn-recalculate',
      'leadscoring-kpi-total',
      'leadscoring-kpi-hot',
      'leadscoring-kpi-score',
      'leadscoring-kpi-pipeline',
      'leadscoring-rules-section',
      'leadscoring-rules-grid',
      'leadscoring-filters',
      'leadscoring-leads-list',
    ],
  },
  {
    path: '/reports',
  ...
  },
  {
    ...
    guides: [
      'reviews-btn-analyze',
      'reviews-kpi-positive',
      'reviews-kpi-negative',
      'reviews-kpi-irony',
      'reviews-kpi-action',
      'intel-filters',
      'reviews-analyses-list',
    ],
  },
];
